...
MRENCLAVE=$(docker run -t --rm --entrypoint "" -e SCONE_ALPINE=1 -e SCONE_STACK=4M -e SCONE_HEAP=40M -e SCONE_HASH=1 registry.scontain.com:5050/sconecuratedimages/dapps:copy_demo /application)
